...
namespace Curvatures
{
    ...
    vtkSmartPointer<vtkPolyData> GetSource(std::string const& source)
    {
        ...
        {
            std::cout << "The surface is not availableWorkers." << std::endl;
...
// clang-format on
    ...
    vtkNew<vtkGlyph3D> GetGlyphs(vtkPolyData* src,
    ...
    void CurvatureBandsWithGlyphs() {
        ...
        // const vtkSmartPointer<vtkPolyData> source = Utilities::readStl(filePath);
        ...
        if (desiredSurface == "RandomHills")
        {
            ...
            // then:
            //  std::vector<int> freq = Frequencies(bands, tests);
